...

{
                    ...
                    (this.CheckSubType(l) == 1 && l % 7 < 3))
            {
                ...
                if (random.nextInt(10) > 1)
                {
                    ...
                    if (!lv2 && l % 7 > 3)
                    {
                        ...
                        {
                            if ((world.getBlockId(i, j + 1, k) != mod_Fossil.FernUpper.blockID) && (world.getBlockId(i, j - 1, k) != mod_Fossil.Ferns.blockID))
                            {
                                l--;
                            }
                        }
                    ...
                    if (l == 1 && new Random().nextInt(10) < 5)
                    {
                        l += 7;
                    }
                ...
                {
                    if (!lv2 && random.nextInt(100) < 5)
                    {
                        this.breakBlock(world, i, j, k, blockID, l);
                    }
                }
            }
        }
    ...
    public int getBlockTextureFromSideAndMetadata(int i, int j)
    {
        ...
        else
        {
            ...
            {
                return mod_Fossil.FernPics[j + 2];
            }
        }
    }
 ...
 //       return -1;
    ...
    public static boolean CheckUnderTree(World wld, int x, int y, int z)
    {
        for (int i = y; i <= 128; i++)
        {
            if (wld.getBlockId(x, i, z) == Block.leaves.blockID)
            {
                return true;
            }
        }
    ...
    public boolean canBlockStay(World world, int i, int j, int k)
    {
        ...
        if (lv2)
        {
            return (world.getBlockId(i, j - 1, k) == mod_Fossil.Ferns.blockID);
        }
        else
        {
            int l = world.getBlockMetadata(i, j, k);
            ...
            if (l % 7 > 3)
            {
                res &= (world.getBlockId(i, j + 1, k) == mod_Fossil.FernUpper.blockID);
            }
    ...
    {
        return mod_Fossil.FernSeed.itemID;
    }
}