...
public class ItemEmbryoSyringe extends ForgeItem
{
    ...
    public String getItemNameIS(ItemStack itemstack)
    {
        ...
        if (tmp < this.ItemNames.length)
        {
            return this.ItemNames[tmp];
        }
    ...
    public boolean itemInteractionForEntity(ItemStack itemstack, EntityLiving entityliving)
    {
        if (entityliving instanceof EntityAnimal && ((EntityAnimal)entityliving).getGrowingAge() == 0)
        {
            ...
            {
                entityanimal1 = new EntityPregnantPig(entityliving.worldObj);
            }

            if (entityliving instanceof EntityCow)
            {
                entityanimal1 = new EntityPregnantCow(entityliving.worldObj);
            }
            ...
            if (entityanimal1 != null)
            {
                ...
                {
                    entityliving.worldObj.spawnEntityInWorld(((EntityAnimal)entityanimal1));
                }
