...
public class FossilKeyHandler extends KeyHandler
{
    ...
    {
        if (kb.keyCode == jumpKeyBinding.keyCode)
        {
            pressedKey[0] = true;
        }

        if (kb.keyCode == forwardKeyBinding.keyCode)
        {
            pressedKey[1] = true;
        }

        if (kb.keyCode == backwardKeyBinding.keyCode)
        {
            pressedKey[2] = true;
        }

        if (kb.keyCode == rightturnKeyBinding.keyCode)
        {
            pressedKey[3] = true;
        }

        if (kb.keyCode == leftturnKeyBinding.keyCode)
        {
            pressedKey[4] = true;
        }
