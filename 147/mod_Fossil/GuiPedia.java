...
public class GuiPedia extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(new StringBuilder().append(this.dino.getDinoAge()).append(" days").toString(), 115, 31, 4210752);
        this.fontRenderer.drawString(new StringBuilder().append(this.dino.getHealth()).append('/').append(this.dino.getMaxHealth()).toString(), 115, 47, 4210752);
        this.fontRenderer.drawString(new StringBuilder().append(this.dino.getHunger()).append('/').append(this.dino.getHungerLimit()).toString(), 115, 62, 4210752);
