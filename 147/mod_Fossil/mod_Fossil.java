...
@Mod(modid = "mod_Fossil", name = "Fossil/Archeology", version = "v7.3.0a Unofficial")
...
//    }
        ...
        try
        {
            ...
            if (props != null)
            {
                if (props.containsKey("AnuSpawn") && !OldFileDetected)
                {
                    ...
                    if (FossilOptions.isNegtiveWord(SpawnTmp))
                    {
    ...
    private void registerBlocks()
    {
        ...
        GameRegistry.registerBlock(Dump, "fossil_Dump");
    ...
    private void initBlockAndItems() throws IDException
    {
        ...
        for (int i = 0; i < ItemIDs.length; i++)
        {
            if (ItemIDs[i] >= Item.itemsList.length || Item.itemsList[ItemIDs[i]] != null)
            {
                preChkResult.add(ItemIDs[i]);
            }
        }

        if (preChkResult.IsConflicted())
        {
            throw preChkResult;
        }
        ...
        Ferns = new BlockFern(BlockIDs[9], 0, false).setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setRequiresSelfNotify().setCreativeTab(null);
        FernUpper = new BlockFern(BlockIDs[10], 0, true).setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setRequiresSelfNotify().setCreativeTab(null);
...
//        FernSeed = new ItemSeeds(ItemIDs[7], Ferns.blockID, Block.grass.blockID).setItemName("FernSeed").setCreativeTab(CreativeTabs.tabMaterials);
    ...
    {
        biofossil.setIconIndex(38);
        relic.setIconIndex(39);
        stoneboard.setIconIndex(44);
        BrokenSword.setIconIndex(0);
        AncientSword.setIconIndex(1);
        FernSeed.setIconIndex(40);
        Brokenhelmet.setIconIndex(2);
        Ancienthelmet.setIconIndex(3);
        SkullStick.setIconIndex(5);
        Gen.setIconIndex(4);
        GenAxe.setIconIndex(19);
        GenPickaxe.setIconIndex(18);
        GenSword.setIconIndex(16);
        GenHoe.setIconIndex(20);
        GenShovel.setIconIndex(17);
        DinoPedia.setIconIndex(53);
        ChickenSoup.setIconIndex(58);
        ChickenEss.setIconIndex(59);
        EmptyShell.setIconIndex(42);
        SJL.setIconIndex(43);
        MagicConch.setIconIndex(21);
        CookedDinoMeat.setIconIndex(56);
        EmbyoSyringe.setIconIndex(0);
        IcedMeat.setIconIndex(57);
    }   
/*    
    private void iconIndexSetup()
    {
...
*/
    ...
    private void reciptsSetup()
    {
        GameRegistry.addRecipe(new ItemStack(SkullLantern, 1), new Object[]
                {
                    "X", "Y", 'X', blockSkull, 'Y', Block.torchWood
                });
...
//3.0 Contects
        GameRegistry.addRecipe(new ItemStack(blockcultivateIdle, 1), new Object[]
                {
                    "XYX", "XWX", "ZZZ", 'X', Block.glass, 'Y', new ItemStack(Item.dyePowder, 1, 2), 'W', Item.bucketWater, 'Z', Item.ingotIron
                });
        GameRegistry.addRecipe(new ItemStack(blockanalyzerIdle, 1), new Object[]
                {
                    "XYX", "XWX", 'X', Item.ingotIron, 'Y', relic, 'W', biofossil
                });
        GameRegistry.addRecipe(new ItemStack(blockworktableIdle, 1), new Object[]
                {
                    "X", "Y", 'X', Item.paper, 'Y', Block.workbench
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 0)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 1)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 2)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 3)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 5)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 6)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 7)
                });
        GameRegistry.addRecipe(new ItemStack(Item.cake, 1), new Object[]
                {
                    "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B', Item.sugar, 'C', Item.wheat, 'E', new ItemStack(Ancientegg, 1, 8)
                });
//4.0 contents
        GameRegistry.addRecipe(new ItemStack(SkullStick, 1), new Object[]
                {
                    "X", "Y", 'X', blockSkull, 'Y', Item.stick
                });
        GameRegistry.addRecipe(new ItemStack(Dump, 1), new Object[]
                {
                    "ZZZ", "XYX", "XXX", 'X', Block.planks, 'Y', Item.redstone, 'Z', Item.leather
                });
        GameRegistry.addRecipe(new ItemStack(FeederIdle, 1), new Object[]
                {
                    "XYX", "ZAB", "BBB", 'X', Item.ingotIron, 'Y', Block.glass, 'Z', Block.stoneButton, 'A', Item.bucketEmpty, 'B', Block.stone
                });
        ...
        GameRegistry.addRecipe(new ItemStack(ChickenEss, 8), new Object[]
                {
                    "XXX", "XYX", "XXX", 'X', Item.glassBottle, 'Y', new ItemStack(ChickenSoup, 1, 1)
                });
    }
    private void smeltingSetup()
    {
        ...
        try
        {
        	  FurnaceRecipes.smelting().addSmelting(Ancientegg.itemID, EnumDinoType.Nautilus.ordinal(), new ItemStack(SJL), 0.3f);
        }
        catch (Throwable e) {}
    }
...
//        EntityRegistry.addSpawn(EntityNautilus.class, 5, 4, 14, EnumCreatureType.waterCreature, avaliableBiomes);
        EntityRegistry.addSpawn(EntityNautilus.class, 5, 4, 14, EnumCreatureType.waterCreature, BiomeGenBase.beach);
    ...
    public void UpdateName(boolean Init)
    {
        ...
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Mammoth.name", "Mammoth");
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Brachiosaurus.name", "Brachiosaurus");        
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.SaberCat.name", "SaberCat");                
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Utahraptor.name", "Utahraptor");        
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Stegosaurus.name", "Stegosaurus");        
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Mosasaurus.name", "Mosasaurus");        
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Plesiosaur.name", "Plesiosaur"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Pterosaur.name", "Pterosaur"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.PigBoss.name", "Pig Boss"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.FriendlyPigZombie.name", "Friendly Pig Zombie"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Tyrannosaurus.name", "Tyrannosaurus"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Triceratops.name", "Triceratops"); 
        LanguageRegistry.instance().addStringLocalization("entity.mod_Fossil.Failuresaurus.name", "Failuresaurus"); 
