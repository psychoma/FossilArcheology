...
public class ModelSaberCat extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLiving entityliving, float f, float f1, float f2)
    {
        ...
        if (entitySaberCat.isSitting())
        {
            ...
            H2.rotateAngleX = -((float)Math.PI / 4F);
            H3.setRotationPoint(0F, 23F, 4.5F);
            D__R2.setRotationPoint(-1.5F, 25F, 1.0F);
            D__R2.rotateAngleX = ((float)Math.PI * 3F / 2F);
            D__L2.setRotationPoint(1.5F, 25F, 1.0F);
            D__L2.rotateAngleX = ((float)Math.PI * 3F / 2F);
        ...
        else
        {
            ...
            D__L2.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
            D__R1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
