...
public class ModelPterosaurFlying extends ModelPterosaurGround
{
    public ModelPterosaurFlying()
    {
        ...
        Neck_1.rotateAngleX = ((float)Math.PI / 2F);
        ...
        New_Shape1.rotateAngleX = ((float)Math.PI / 2F);
        ...
        Left_wing_1.rotateAngleX = -((float)Math.PI / 2F);
        Left_wing_1.rotateAngleY = (float)Math.PI;
        ...
        Right_wing_1.rotateAngleX = ((float)Math.PI / 2F);
        ...
        Left_wing_2.rotateAngleX = ((float)Math.PI / 2F);
        ...
        Right_wing_2.rotateAngleX = -((float)Math.PI / 2F);
        Right_wing_2.rotateAngleY = (float)Math.PI;
        ...
        Head.rotateAngleX = ((float)Math.PI / 2F);
        ...
        Left_leg.rotateAngleX = ((float)Math.PI / 2F);
        ...
        right_leg.rotateAngleX = ((float)Math.PI / 2F);
            ...
            float f4, float f5, boolean modelized)
    {
        ...
        Left_wing_1.rotateAngleX = -((float)Math.PI / 2F) + this.AirPitch;
        Left_wing_2.rotateAngleX = ((float)Math.PI / 2F) + this.AirPitch;
        Right_wing_1.rotateAngleX = ((float)Math.PI / 2F) - this.AirPitch;
        Right_wing_2.rotateAngleX = -((float)Math.PI / 2F) - this.AirPitch;
