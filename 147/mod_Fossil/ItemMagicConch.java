...
public class ItemMagicConch extends Item
{
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        String OrderString = "";
        List list = world.getEntitiesWithinAABB(EntityPlesiosaur.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.posX + 1.0D, entityplayer.posY + 1.0D, entityplayer.posZ + 1.0D).expand(30D, 4D, 30D));
