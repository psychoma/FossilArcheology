...
public class EntityDinoEgg extends Entity implements IEntityAdditionalSpawnData
{
    ...
    public String getTexture()
    {
        ...
        if (IntType < 4)
        {
            return new StringBuilder().append("/skull/eggTexture").append(IntType + 1).append(".png").toString();
        }
        else
        {
            return new StringBuilder().append("/skull/eggTexture").append(IntType).append(".png").toString();
        }
