...
public class Modeldil extends ModelDinosaurs
{
    ...
    {
        if (Jaw2.rotateAngleX < 0.4363323F)
        {
            Jaw2.rotateAngleX += (0.4363323F / Steps);
        }
        else
        {
            Jaw2.rotateAngleX = 0.4363323F;
        }
            ...
            float f4, float f5, boolean modelized)
    {
        ...
        //left leg
        Thigh1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
        Heel1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 - 0.372F;
        Feet1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
    }
}
