...
public class EntityPlesiosaur extends EntityDinosaurce implements IWaterDino
{
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.riddenByEntity == null)
        {
            ...
            if (!this.isOnSurface() && this.TargetY < this.posY)
            {
    ...
    public void onUpdate()
    {
        ...
        if (this.isInWater())
        {
            ...
            if ((Math.abs(this.posY - this.TargetY) <= 0.125))
            {
                this.motionY = 0;
            }
        }
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        {
            //if (EatTick<=0){
            if ((itemstack.itemID == Item.fishRaw.itemID || itemstack.itemID == Item.fishCooked.itemID) && HandleEating(45))
            {
                itemstack.stackSize--;
        ...
        if (itemstack != null && itemstack.itemID == mod_Fossil.EmptyShell.itemID)
        {
            //need change
            ...
            if (NearBy != null)
            {
                for (int i = 0; i < NearBy.size(); i++)
                {
                    if (NearBy.get(i) instanceof EntityItem)
                    {
                        ...
                        if (ItemInRange.func_92014_d().itemID == Item.fishRaw.itemID || ItemInRange.func_92014_d().itemID == Item.fishCooked.itemID)
                        {
                            HandleEating(10);
        ...
        if (riddenByEntity != null)
        {
            if (this.riddenByEntity instanceof EntityPlayerSP)
            {
                ...
                else
                {
                    ...
                    else if (((EntityPlayerSP) this.riddenByEntity).movementInput.moveForward == 0)
                    {
    ...
    public EntityPlesiosaur spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
    ...
    {
        if (asked == Item.fishRaw || asked == Item.fishCooked || asked == mod_Fossil.SJL)
        {
            return 10;
        }
