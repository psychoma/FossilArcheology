    ...
    implements IInventory, ISidedInventory
{
    ...
    {
        if (target == Item.egg.itemID)
        {
            return 100;
        }

        if (target == Item.porkRaw.itemID)
        {
            return 20;
        }

        if (target == Item.porkCooked.itemID)
        {
            return 30;
        }

        if (target == Item.chickenCooked.itemID)
        {
            return 10;
        }

        if (target == Item.chickenRaw.itemID)
        {
            return 30;
        }

        if (target == Item.beefCooked.itemID)
        {
            return 20;
        }

        if (target == Item.beefRaw.itemID)
        {
            return 40;
        }

        if (target == Item.fishRaw.itemID)
        {
            return 40;
        }

        if (target == Item.fishCooked.itemID)
        {
            return 60;
        }

        if (target == Item.slimeBall.itemID)
        {
            return 10;
        }

        if (target == mod_Fossil.RawDinoMeat.itemID)
        {
            return 100;
        }

        if (target == mod_Fossil.CookedDinoMeat.itemID)
        {
            return 100;
        }
    ...
    {
        if (target == mod_Fossil.FernSeed.itemID)
        {
            return 50;
        }

        if (target == Item.appleRed.itemID)
        {
            return 100;
        }

        if (target == Item.wheat.itemID)
        {
            return 40;
        }

        if (target == Item.reed.itemID)
        {
            return 20;
        }

        if (target == Item.paper.itemID)
        {
            return 60;
        }

        if (target == Item.book.itemID)
        {
            return 180;
        }

        if (target == Item.bread.itemID)
        {
            return 120;
        }

        if (target == Item.melon.itemID)
        {
            return 25;
        }
