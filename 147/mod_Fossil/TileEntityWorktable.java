    ...
    implements IInventory, ISidedInventory
{
    ...
    {
        if (index == mod_Fossil.BrokenSword.itemID)
        {
            return new ItemStack(mod_Fossil.AncientSword);
        }

        if (index == mod_Fossil.Brokenhelmet.itemID)
        {
            return new ItemStack(mod_Fossil.Ancienthelmet);
        }

        if (index == mod_Fossil.GenAxe.itemID)
        {
            return new ItemStack(mod_Fossil.GenAxe);
        }

        if (index == mod_Fossil.GenPickaxe.itemID)
        {
            return new ItemStack(mod_Fossil.GenPickaxe);
        }

        if (index == mod_Fossil.GenSword.itemID)
        {
            return new ItemStack(mod_Fossil.GenSword);
        }

        if (index == mod_Fossil.GenHoe.itemID)
        {
            return new ItemStack(mod_Fossil.GenHoe);
        }

        if (index == mod_Fossil.GenShovel.itemID)
        {
