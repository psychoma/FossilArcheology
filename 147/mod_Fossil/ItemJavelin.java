...
public class ItemJavelin extends ForgeItem
{
    ...
    {
        if (this.SelfMaterial == EnumToolMaterial.GOLD)
        {
            return 52;
        }

        if (this.SelfMaterial == EnumToolMaterial.EMERALD)
        {
            return 51;
        }
    ...
    public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer entityplayer, int i)
    {
        ...
        if (flag || entityplayer.inventory.hasItem(this.itemID))
        {
            ...
            if (!this.isAncient)
            {
                entityjavelin = new EntityJavelin(world, entityplayer, f * 2.0F, this.SelfMaterial);
            }
            else
            {
                entityjavelin = new EntityAncientJavelin(world, entityplayer, f * 2.0F, this.SelfMaterial);
            }
