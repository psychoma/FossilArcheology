...
public class WorldGenDukeWreck implements IWorldGenerator
{
    @Override
    ...
    private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
    	...
    	WorldGeneratorDukeWreck dukewreck = new WorldGeneratorDukeWreck();
    	if(biome instanceof BiomeRiver2)
   	 	{
    	...
    	for (int x = 0;x<4;x++)
        {
            ...
            {
            	dukewreck.generate(world, random, var6, var8, var7);
            }
        }
   	 	}
