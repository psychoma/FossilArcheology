...
import mod.fossil.common.fossilAI.EntityAIBegSC;
...
public class EntitySaberCat extends EntityTameable
{
    ...
    {
        super(var1);
        this.texture = "/mod/fossil/common/textures/SaberCat_Adult.png";
    ...
    {
        return this.isChild() ? "/mod/fossil/common/textures/SaberCat_Young.png" : "/mod/fossil/common/textures/SaberCat_Adult.png";
    }
