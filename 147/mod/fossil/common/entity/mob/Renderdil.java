...
{
    public Renderdil(ModelBase var1, float var2)
    {
        super(var1, var2);
    }

    public void RenderDino(Entitydil var1, double var2, double var4, double var6, float var8, float var9)
    {
        GL11.glPushMatrix();
        ...
        try
        {
            ...
            {
                ((Modeldil)this.mainModel).CloseMouth(10);
            }
            else
            {
                ((Modeldil)this.mainModel).OpenMouth(5);
            }

            ((Modeldil)this.mainModel).render(var1, var16, var15, var13, var11 - var10, var12, var14);
