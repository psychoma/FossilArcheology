...
public class RenderTriceratops extends RenderLiving
{
    ...
    public RenderTriceratops(ModelBase var1, ModelBase var2, float var3)
    {
        super(var1, var3);
    ...
    public void renderCow(EntityTriceratops var1, double var2, double var4, double var6, float var8, float var9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderCow((EntityTriceratops)var1, var2, var4, var6, var8, var9);
    }
    ...
    protected int shouldRenderPass(EntityLiving var1, int var2, float var3)
    {
        ...
        {
            this.loadTexture("/mod/fossil/common/textures/Tri_Hurt.png");
            return 1;
        }
        else
        {
