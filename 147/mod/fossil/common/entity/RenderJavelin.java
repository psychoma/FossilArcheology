...
public class RenderJavelin extends Render
{
    public void renderJavelin(EntityJavelin var1, double var2, double var4, double var6, float var8, float var9)
    {
        switch (RenderJavelin$1.$SwitchMap$net$minecraft$item$EnumToolMaterial[var1.SelfMaterial.ordinal()])
        {
            ...
            case 2:
                this.loadTexture("/mod/fossil/common/textures/IronJavelin.png");
                break;

            case 3:
                this.loadTexture("/mod/fossil/common/textures/GoldJavelin.png");
                break;

            case 4:
                this.loadTexture("/mod/fossil/common/textures/DiamondJavelin.png");
                break;

            case 5:
            default:
                this.loadTexture("/mod/fossil/common/textures/WoodenJavelin.png");
        }

        if (var1 instanceof EntityAncientJavelin)
        {
            this.loadTexture("/mod/fossil/common/textures/AncientJavelin.png");
        }
