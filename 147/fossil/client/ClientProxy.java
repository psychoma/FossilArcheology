...
import fossil.entity.mob.ModelUtahraptor;
...
import fossil.entity.mob.RenderUtahraptor;
...
public class ClientProxy extends CommonProxy
{
	...
	public void registerRenderThings()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityUtahraptor.class, new RenderUtahraptor(new ModelUtahraptor(), 0.5F));
