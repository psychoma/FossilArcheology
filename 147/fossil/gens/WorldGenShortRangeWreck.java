...
public class WorldGenShortRangeWreck implements IWorldGenerator
{
    @Override
    ...
    private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
    	...
    	WorldGeneratorShortRangeWreck shortrangewreck = new WorldGeneratorShortRangeWreck();
    	...
    	for (int x = 0;x<4;x++)
        {
            ...
            {
            	shortrangewreck.generate(world, random, var6, var8, var7);
            }
        }
   	 	}
