...
public class BlockCultivate extends BlockContainer
{
    ...
    {
        this.Bottom = par1IconRegister.registerIcon("Fossil_Archeology:Culture_Bottom");
        this.Top = par1IconRegister.registerIcon("Fossil_Archeology:Culture_Top");
        this.blockIcon = this.isActive? par1IconRegister.registerIcon("Fossil_Archeology:Culture_Sides_Active") : par1IconRegister.registerIcon("Fossil_Archeology:Culture_Sides_Idle");
    }
