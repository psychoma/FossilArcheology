...
public class BlockAnalyzer extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Fossil_Archeology:Analyser_Sides");
        this.Top = par1IconRegister.registerIcon("Fossil_Archeology:Analyser_Top");
        this.Front = this.isActive? par1IconRegister.registerIcon("Fossil_Archeology:Analyser_Front_Active") : par1IconRegister.registerIcon("Fossil_Archeology:Analyser_Front_Idle");
    }
