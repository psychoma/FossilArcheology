...
public class BlockFeeder extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Fossil_Archeology:Feeder_Sides");
        this.Bottom = par1IconRegister.registerIcon("Fossil_Archeology:Feeder_Bottom");
        this.Top1 = par1IconRegister.registerIcon("Fossil_Archeology:Feeder_Top1");
