...
public class BlockTimeMachine extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Fossil_Archeology:TM_Side1");
        this.Side2 = par1IconRegister.registerIcon("Fossil_Archeology:TM_Side2");
        this.Top = par1IconRegister.registerIcon("Fossil_Archeology:TM_Top");
        this.Bottom = par1IconRegister.registerIcon("Fossil_Archeology:TM_Bottom");
    }
