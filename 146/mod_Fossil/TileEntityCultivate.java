    ...
    implements IInventory, ISidedInventory
{
    ...
    private int getItemBurnTime(ItemStack itemstack)
    {
        ...
        if (i == mod_Fossil.biofossil.shiftedIndex)
        {
            return 300;
        }

        if (i == mod_Fossil.ChickenSoup.shiftedIndex)
        {
            return 1000;
        }

        if (i == mod_Fossil.Ancientegg.shiftedIndex)
        {
            return 12000;
        }
        ...
        if (i == Item.beefRaw.shiftedIndex)
        {
            return 4000;
        }

        if (i == mod_Fossil.RawDinoMeat.shiftedIndex)
        {
            return 4000;
        }

        if (i == Item.chickenRaw.shiftedIndex)
        {
            return 1500;
        }
        ...
        if (i == Item.slimeBall.shiftedIndex)
        {
            return 800;
        }

        if (i == Item.bucketMilk.shiftedIndex)
        {
            return 6000;
        }
        else
    ...
    {
        if (Itemstack.itemID == mod_Fossil.DNA.shiftedIndex)
        {
