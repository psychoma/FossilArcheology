...
public class Entitydil extends EntityDinosaurce
{
    ...
    {
        if (rand.nextInt(16) < 4 && par1Entity instanceof EntityLiving)
        {
            ((EntityLiving)par1Entity).addPotionEffect(new PotionEffect(Potion.blindness.id, rand.nextInt(110) + 10, 0));
        }
    ...
    protected void attackEntity(Entity entity, float f)
    {
        ...
        else if ((double)f < 1.9F && entity.boundingBox.maxY > boundingBox.minY && entity.boundingBox.minY < boundingBox.maxY)
        {
            ...
            if (rand.nextInt(16) < 4 && entity instanceof EntityLiving)
            {
                ((EntityLiving)entity).addPotionEffect(new PotionEffect(Potion.blindness.id, rand.nextInt(110) + 10, 0));
            }
        }
    }
    ...
    public void CheckSkin()
    {
        ...
        {
            this.texture = "/skull/UtaAttack.png";
        }
        else
        {
            this.texture = "/skull/UtaCalm.png";
        }
    }
    ...
    public Entitydil spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
