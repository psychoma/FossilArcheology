...
public class ModelTNClock extends ModelBase
{
    ...
    public ModelTNClock()
    {
        ...
        setRotation(C3, 0F, 0F, ((float)Math.PI / 4F));
        C3.mirror = true;
        ...
        setRotation(C31, 0F, 0F, ((float)Math.PI / 4F));
        C31.mirror = true;
    }
    ...
    public void EdgeRotate(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        //C2.rotateAngleY = MathHelper.cos(f / (1.919107651F * 2.5F )) * (float)Math.PI * f1 + 0F ;
        C2.rotateAngleZ = MathHelper.cos(f / (1.919107651F * 5F)) * (float)Math.PI * f1 + 0F ;
        //C3.rotateAngleY = MathHelper.cos(f / (1.919107651F * 2.5F )) * (float)Math.PI * f1 + 0F ;
        C3.rotateAngleX = MathHelper.cos(f / (1.919107651F * 2.5F)) * 0.523598775598299F * f1 + 0F ;
        C3.rotateAngleZ = MathHelper.cos(f / (1.919107651F * 5F)) * (float)Math.PI * f1 + ((float)Math.PI / 4F) ;
        C21.rotateAngleX = MathHelper.cos(f / (1.919107651F * 2.5F)) * -0.523598775598299F * f1 + 0F ;
        //C21.rotateAngleY = MathHelper.cos(f / (1.919107651F * 2.5F )) * -(float)Math.PI * f1 + 0F ;
        C21.rotateAngleZ = MathHelper.cos(f / (1.919107651F * 5F)) * -(float)Math.PI * f1 + 0F ;
        C31.rotateAngleX = MathHelper.cos(f / (1.919107651F * 2.5F)) * -0.523598775598299F * f1 + 0F ;
        //C31.rotateAngleY = MathHelper.cos(f / (1.919107651F * 2.5F )) * -(float)Math.PI * f1 + 0F ;
        C31.rotateAngleZ = MathHelper.cos(f / (1.919107651F * 5F)) * -(float)Math.PI * f1 + ((float)Math.PI / 4F) ;
    }
    public void EdgePullBack()
    {
        ...
        C3.rotateAngleX = 0F ;
        C3.rotateAngleY = 0F ;
        C3.rotateAngleZ = ((float)Math.PI / 4F) ;
        C21.rotateAngleX = 0F ;
        C21.rotateAngleY = 0F ;
        C21.rotateAngleZ = 0F ;
        C31.rotateAngleX = 0F ;
        C31.rotateAngleY = 0F ;
        C31.rotateAngleZ = ((float)Math.PI / 4F) ;
    }
    public void UpdateTime(float HourRndAngle, float MinRndAngle)
    {
        if (HourRndAngle <= Math.PI)
        {
            H.rotateAngleZ = HourRndAngle;
        }
        else
        {
            H.rotateAngleZ = (float)(HourRndAngle - 2 * Math.PI);
        }

        if (MinRndAngle <= Math.PI)
        {
            M.rotateAngleZ = MinRndAngle;
        }
        else
        {
            M.rotateAngleZ = (float)(MinRndAngle - 2 * Math.PI);
        }
    }
