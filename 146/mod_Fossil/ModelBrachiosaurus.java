...
public class ModelBrachiosaurus extends ModelDinosaurs
{
    ...
    public ModelBrachiosaurus()
    {
        ...
        setRotation(Neck, -((float)Math.PI / 4F), 0F, 0F);
        Neck.mirror = true;
            ...
            float f4, float f5, boolean modelized)
    {
        ...
        Front_Thigh1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
        Front_Calf2.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
        Back_Thigh1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
        Back_CalfRight.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
