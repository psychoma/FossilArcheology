...
public class ModelTriceratops extends ModelDinosaurs
{
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, boolean modelized)
    {
        ...
        head11.rotateAngleY = -f3 / (180F / (float)Math.PI);
        head2.rotateAngleY = -f3 / (180F / (float)Math.PI);
        head3.rotateAngleY = -f3 / (180F / (float)Math.PI);
        horn_3.rotateAngleY = -f3 / (180F / (float)Math.PI);
        horn_1_R.rotateAngleY = -f3 / (180F / (float)Math.PI);
        horn_1_R1.rotateAngleY = -f3 / (180F / (float)Math.PI);
        horn_2_L.rotateAngleY = -f3 / (180F / (float)Math.PI);
        horn_1_R2.rotateAngleY = -f3 / (180F / (float)Math.PI);*/
