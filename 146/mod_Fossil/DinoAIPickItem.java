...
public class DinoAIPickItem extends EntityAIBase
{
    ...
    {
        if (entityVar.getHunger() > HUNT_LIMIT)
        {
            return false;
        }
    ...
    public void startExecuting()
    {
        ...
        {
            this.entityVar.PickUpItem(targetItem.func_92014_d().getItem());
            targetItem.setDead();
    ...
    private Vec3 getNearestItem()
    {
        ...
        while (var2.hasNext())
        {
            ...
            if (WANTED_ITEM == null || var3.func_92014_d().itemID == WANTED_ITEM.shiftedIndex)
            {
                targetItem = var3;
