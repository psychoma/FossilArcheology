...
//        this.onKillEntity((EntityLiving)entity);
    ...
    public boolean attackEntityFrom(DamageSource damagesource, int i)//being attack
    {
        ...
        if (i < 6 && entity != null && this.getDinoAge() >= 3)
        {
            return false;
        }
            ...
            if (itemstack != null)
            {
                if (itemstack.itemID == mod_Fossil.Gen.shiftedIndex)
                {
                    ...
                    else
                    {
                        ...
                        {
                            SendStatusMessage(EnumSituation.GemErrorYoung, this.SelfType);
                        }
    ...
    private void InitSize()
    {
        ...
        if (getDinoAge() > 3 && !this.isTamed())
        {
            texture = "/skull/TRex_Adult.png";
        }
        else
        {
            texture = "/skull/TRex.png";
    ...
    protected void jump()
    {
        if (!this.isInWater())
        {
            if (this.riddenByEntity != null)
            {
                this.motionY += 0.41999998688697815D * 1.5;
            }
            else
            {
                super.jump();
...
//        return false;
 ...
 //       return ((this.getHunger()==1 || this.getHealth()<=20) && this.getDinoAge()>3 && !this.isTamed());
    ...
    private void HandleWeak()
    {
        ...
        if (texture != "/skull/TRexWeak.png")
        {
            texture = "/skull/TRexWeak.png";
        }
