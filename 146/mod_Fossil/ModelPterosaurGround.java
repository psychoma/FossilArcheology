...
public class ModelPterosaurGround extends ModelDinosaurs
{
            ...
            float f4, float f5, boolean modelized)
    {
        ...
        crown.rotateAngleY = upper_mouth.rotateAngleY = lower_mouth.rotateAngleY = Head.rotateAngleY = -f3 / (180F / (float)Math.PI);
        right_leg.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1 - 0.271F;
        Left_leg.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 - 0.271F;
    }
}
