...
//        if (this.theEntity.getHunger() < huntLimit && this.theEntity.rand.nextInt(100) < percentage)
            if (this.theEntity.getHunger() < huntLimit && this.theEntity.getRNG().nextInt(100) < percentage)
        {
            return true;
        }
    ...
    {
        Random randSeed = this.theEntity.getRNG();
    ...
    private boolean nearbyGotWater()
    {
        ...
        if (this.theEntity.worldObj.isAnyLiquid(boxTmp))
        {
            return true;
        }
