    ...
    implements IInventory, ISidedInventory
{
    ...
    private int getItemBurnTime(ItemStack itemstack)
    {
        ...
        if (i == mod_Fossil.relic.shiftedIndex)
        {
            return 300;
        }
        else
    ...
    {
        if (index == mod_Fossil.BrokenSword.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.AncientSword);
        }

        if (index == mod_Fossil.Brokenhelmet.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.Ancienthelmet);
        }

        if (index == mod_Fossil.GenAxe.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.GenAxe);
        }

        if (index == mod_Fossil.GenPickaxe.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.GenPickaxe);
        }

        if (index == mod_Fossil.GenSword.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.GenSword);
        }

        if (index == mod_Fossil.GenHoe.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.GenHoe);
        }

        if (index == mod_Fossil.GenShovel.shiftedIndex)
        {
            return new ItemStack(mod_Fossil.GenShovel);
        }
