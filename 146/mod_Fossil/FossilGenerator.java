...
public class FossilGenerator implements IWorldGenerator
{
            ...
            IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
    {
        for (int i = 0; i < 20; i++)
        {
            ...
            {
                (new WorldGenMinable(mod_Fossil.blockPermafrost.blockID, 5)).generate(world, random, chunkX * 16 + random.nextInt(16), random.nextInt(40), chunkZ * 16 + random.nextInt(16));
            }
