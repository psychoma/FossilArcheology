...
{
    World worldObj = null;
    EntityDinosaur destroyer = null;
    int ageLimit;
    Block[] targetBlocks = null;

    public BlockBreakingRule(World var1, EntityDinosaur var2, int var3, Block[] var4)
    {
        this.worldObj = var1;
        this.destroyer = var2;
        this.ageLimit = var3;
    ...
    public BlockBreakingRule(World var1, EntityDinosaur var2, int var3, float var4)
    {
