...
public class BlockAnalyzer extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Analyser_Sides");
        this.Top = par1IconRegister.registerIcon("Analyser_Top");
        this.Front = this.isActive? par1IconRegister.registerIcon("Analyser_Front_Active") : par1IconRegister.registerIcon("Analyser_Front_Idle");
    }
