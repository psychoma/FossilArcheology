...
public class BlockFeeder extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Feeder_Sides");
        this.Bottom = par1IconRegister.registerIcon("Feeder_Bottom");
        this.Top1 = par1IconRegister.registerIcon("Feeder_Top1");
        this.Top2 = par1IconRegister.registerIcon("Feeder_Top2");
        this.Top3 = par1IconRegister.registerIcon("Feeder_Top3");
        this.Top4 = par1IconRegister.registerIcon("Feeder_Top4");
        this.Front1 = par1IconRegister.registerIcon("Feeder_Front4");
        this.Front2 = par1IconRegister.registerIcon("Feeder_Front4");
        this.Front3 = par1IconRegister.registerIcon("Feeder_Front4");
        this.Front4 = par1IconRegister.registerIcon("Feeder_Front4");
    }
