...
public class EntityMammoth extends EntityTameable implements IShearable
{
    ...
    {
        super(var1);
        this.texture = "/mod/fossil/common/textures/MammothAdult.png";
    ...
    {
        return this.isChild() ? "/mod/fossil/common/textures/MammothYoung.png" : (!this.getSheared() ? "/mod/fossil/common/textures/MammothAdult.png" : "/mod/fossil/common/textures/MammothFurless.png");
    }
